  ...
  const cards = [
    ...
    },
    {
      ...
      points: [
        ...
        "How to prepare effectively with limited time",
      ],
      dark: false,
    },
    {
      ...
      points: [
        ...
        "Practical examples based on actual TEF pattern",
        "Mini level assessment during the session",
        "TEF-focused preparation resources shared",
      ],
      dark: true,
    },
  ];
